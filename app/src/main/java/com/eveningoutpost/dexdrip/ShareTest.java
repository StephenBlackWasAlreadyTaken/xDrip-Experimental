...
public class ShareTest extends Activity {
    ...
    public void attemptConnection() {
        ...
        if (device != null) {
            details.append(getString(R.string.connection_state) + getString(R.string.device_not_null));
        ...
        if (mConnectionState == STATE_DISCONNECTED || mConnectionState == STATE_DISCONNECTING) {
            ActiveBluetoothDevice btDevice = new Select().from(ActiveBluetoothDevice.class)
                    ...
                    .executeSingle();
            if (btDevice != null) {
                details.append(getString(R.string.bt_device) + btDevice.name);
    ...
    public boolean connect(final String address) {
        ...
        details.append(getString(R.string.connecting_to_device2));
        Log.i(TAG, "CONNECTING TO DEVICE");
        if (mBluetoothAdapter == null || address == null) {
            details.append(getString(R.string.bt_adapter_not_null));
            Log.w(TAG, "BluetoothAdapter not initialized or unspecified address.");
            return false;
        }
        if (mBluetoothDeviceAddress != null && address.equals(mBluetoothDeviceAddress) && mBluetoothGatt != null) {
            details.append(getString(R.string.trying_to_user_existing_mbluetoothgatt));
            ...
            details.append(getString(R.string.trying_to_create_new_connection));
            mConnectionState = STATE_CONNECTING;
            return true;
        }
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_BOND_STATE_CHANGED.equals(action)) {
                ...
                if (state == BluetoothDevice.BOND_BONDED) {
                    ...
                    Toast.makeText(getApplicationContext(), R.string.toast_trying_bonding, Toast.LENGTH_LONG).show();
                }
            }
        }
    };
