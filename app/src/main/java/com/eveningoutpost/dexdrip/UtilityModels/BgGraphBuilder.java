...
public class BgGraphBuilder {
    ...
    public Axis previewXAxis(){
        ...
        while (calendar.getTimeInMillis()<end_time){
            previewXaxisValues.add(new AxisValue((long) (calendar.getTimeInMillis() / FUZZER), (timeFormat.format(calendar.getTimeInMillis())).toCharArray()));
            calendar.add(Calendar.HOUR, 1);
        }
