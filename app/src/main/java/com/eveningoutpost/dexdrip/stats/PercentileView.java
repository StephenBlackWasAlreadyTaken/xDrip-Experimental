...
public class PercentileView extends View {
    ...
    private void drawLegend(Canvas canvas) {
        canvas.drawText(getContext().getString(R.string.stats_10_90), dpOffset + dp2px(10), dp2px(14), outerPaintLabel);
        canvas.drawText(getContext().getString(R.string.stats_25_75), dpOffset + dp2px(80), dp2px(14), innerPaintLabel);
        canvas.drawText(getContext().getString(R.string.stats_50_median), dpOffset + dp2px(150), dp2px(14), medianPaintLabel);
    }
